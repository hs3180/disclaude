 ...
 */
export const REST_CHANNEL_DESCRIPTOR = {
    type: 'rest',
    name: 'REST API',
 ...
 */
export const FEISHU_CHANNEL_DESCRIPTOR = {
    type: 'feishu',
    name: 'Feishu',
 ...
 */
export const WECHAT_CHANNEL_DESCRIPTOR = {
    type: 'wechat',
    name: 'WeChat',
 ...
 * ```
 */
export const BUILTIN_CHANNEL_DESCRIPTORS = [
