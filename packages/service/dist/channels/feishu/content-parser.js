 ...
 */
export function extractOpenId(sender) {
    if (!sender?.sender_id) {
        return undefined;
    }
 ...
 */
export function parseChatHistoryElement(element) {
 ...
 */
export function parseShareChatContent(parsed) {
 ...
 */
export function extractSenderName(msgData) {
 ...
 */
export function extractMessageContent(msgData) {
 ...
 */
export function formatMessageTime(msgData) {
