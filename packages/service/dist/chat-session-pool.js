...
export class ChatSessionPool {
    ...
    createAgent(chatId, callbacks, preset, skipHistory = false, sdkSessionKey = chatId, modelOverride) {
    ...
    getOrCreateChatAgent(chatId, callbacks, threadRootId, session) {
        ...
        if (!agent) {
            ...
            const selected = this.presets
                ...
                : undefined;
            agent = this.createAgent(chatId, callbacks, selected?.ok ? selected.preset : undefined, skipHistory, sessionKey, session?.model);
