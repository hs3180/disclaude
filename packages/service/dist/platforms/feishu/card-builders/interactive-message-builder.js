 ...
 * for the sendInteractive REST API flow. disclaude service owns the full card building lifecycle.
 *
 ...
 * }
 */
export function buildActionPrompts(options, customPrompts, template, cardContext) {
