...
export class ChatAgent extends BaseAgent {
     ...
     */
    async runOnce(chatId, text, messageId, senderOpenId, context) {
        // Issue #644: Verify chatId matches bound chatId
        if (chatId !== this.boundChatId) {
    ...
    async processMessage(params) {
        const { chatId, payload: text, messageId, senderOpenId, attachments, chatHistoryContext, chatType, threadContext, projectTaskContext, threadRootId, } = params;
        // Issue #644: Verify chatId matches bound chatId
        if (chatId !== this.boundChatId) {
