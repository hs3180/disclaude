 ...
 */
import { buildChannelCliHelpGuidance } from "../../../../core/dist/index.js";
/**
 * Build Feishu platform header.
 */
function buildFeishuHeader(_ctx) {
 ...
 */
function buildFeishuMentionSection(ctx) {
 ...
 */
function buildFeishuToolsSection(ctx) {
...
function buildFeishuStableToolsSection(ctx) {
    const channelCli = 'disclaude channel';
 ...
 */
function buildFeishuAttachmentExtra(ctx) {
