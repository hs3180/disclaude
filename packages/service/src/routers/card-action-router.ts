 ...
 *
 * When a card is sent, disclaude service records the chatId -> nodeId mapping.
 * When a card action callback is received, disclaude service checks if the context
