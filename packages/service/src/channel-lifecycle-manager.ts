...
/**
 * Minimal interface for DisclaudeService access in channel setup hooks.
 * DisclaudeService satisfies this interface structurally (duck typing).
 */
...
export interface ChannelSetupContext {
  ...
  service: IDisclaudeServiceForSetup;
  /**
