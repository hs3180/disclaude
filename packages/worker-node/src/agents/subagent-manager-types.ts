...
/**
 * Internal context passed to lifecycle functions.
 * Provides access to SubagentManager's internal state.
 *
 * @internal
 */
export interface SubagentContext {
  handles: Map<string, SubagentHandle>;
  processes: Map<string, import('child_process').ChildProcess>;
  inMemoryAgents: Map<string, import('@disclaude/core').ChatAgent>;
  notifyStatusChange: (handle: SubagentHandle) => void;
}
