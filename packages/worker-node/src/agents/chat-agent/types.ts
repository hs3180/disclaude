 ...
 *
 * Extracted from chat-agent.ts for better separation of concerns (Issue #697).
 * Issue #1492: MessageData moved to core package, re-exported here for backward compatibility.
 * Issue #2345: Renamed from PilotCallbacks/PilotConfig to ChatAgentCallbacks/ChatAgentConfig.
 */
 ...
 * Issue #2345: Renamed from PilotConfig to ChatAgentConfig.
 */
