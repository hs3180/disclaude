 ...
 * Issue #2345: Renamed from Pilot to ChatAgent.
 *
 * Key Features:
...
export type { ChatAgentCallbacks, ChatAgentCallbacks as PilotCallbacks, ChatAgentConfig, ChatAgentConfig as PilotConfig, MessageData } from './types.js';
...
/**
 * @deprecated Use ChatAgent instead. Renamed in Issue #2345.
 */
export type Pilot = ChatAgent;
