...
import { validateChatId } from './utils/chatid-validator.js';
...
/**
 * Return a tool error response with isError: true (MCP protocol).
 *
 * Issue #1641: Use isError to signal failure to the agent instead of
 * returning toolSuccess() with warning text, which misleadingly indicates success.
 */
