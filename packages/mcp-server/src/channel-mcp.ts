...
Adds one or more members to an existing group chat. The bot must be the group owner or an admin.

## Parameters
- **chatId**: The group chat ID to add members to
...
\`\`\``,
    parameters: z.object({
      chatId: z.string().describe('The group chat ID to add members to'),
...
Removes one or more members from an existing group chat. The bot must be the group owner or an admin.

## Parameters
- **chatId**: The group chat ID to remove members from
...
\`\`\``,
    parameters: z.object({
      chatId: z.string().describe('The group chat ID to remove members from'),
...
Returns the member IDs of all members in the specified group chat.

## Parameters
- **chatId**: The group chat ID to list members for
...
\`\`\``,
    parameters: z.object({
      chatId: z.string().describe('The group chat ID to list members for'),
    }),
    handler: async ({ chatId }: { chatId: string }) => {
