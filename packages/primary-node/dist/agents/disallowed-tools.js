...
const BASE_DISALLOWED_TOOLS = ['EnterPlanMode', 'AskUserQuestion'];
/**
 ...
 */
const BUILTIN_CRON_TOOLS = ['CronCreate', 'CronList', 'CronDelete', 'ScheduleWakeup'];
 ...
 */
export function buildDisallowedTools(env = process.env) {
    const tools = [...BASE_DISALLOWED_TOOLS];
