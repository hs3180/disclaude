...
export class WeChatApiClient {
  ...
  // ---------------------------------------------------------------------------
  // Media upload (Issue #1556 Phase 3.3)
  // ---------------------------------------------------------------------------
   ...
   *
   * Uploads a file (image, document, etc.) to WeChat's CDN and returns
   * a URL and file_key that can be used in sendImage/sendFile.
   *
  ...
  async uploadMedia(params: {
    ...
    const headers: Record<string, string> = {
      'AuthorizationType': authHeaders['AuthorizationType'],
      'Authorization': authHeaders['Authorization'] || '',
      'X-WECHAT-UIN': authHeaders['X-WECHAT-UIN'],
    };
