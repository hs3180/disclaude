 ...
 * - Media handling (CDN upload) — Phase 3.2
 * - Typing indicator — deprioritized
 * - Thread support via context_token — postponed per #1619
 *
...
export class WeChatChannel extends BaseChannel<WeChatChannelConfig> {
   ...
   *
   * Phase 3.1 adds message listening. File/media support comes in Phase 3.2.
   */
