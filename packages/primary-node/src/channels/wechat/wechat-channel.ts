 ...
 * - Media handling — CDN upload + image/file sending (Issue #1556 Phase 3.3)
 *
...
export class WeChatChannel extends BaseChannel<WeChatChannelConfig> {
   ...
   * File messages are uploaded to CDN then sent as image or file.
   ...
   * - supportsFile: true (via CDN upload, Phase 3.3)
