    ...
    it('should continue processing after processor error', async () => {
      const updates: WeChatUpdate[] = [
        ...
        },
        {
          ...
          from_user_id: 'user-123',
          to_user_id: 'bot-456',
          item_list: [{ type: 1, text_item: { text: 'Will succeed' } }],
      ...
      const erroringProcessor = vi.fn().mockImplementation(async (msg: IncomingMessage) => {
        if (msg.messageId === 'msg-error') {
