...
describe('WeChatMessageListener', () => {
  ...
  describe('deduplication', () => {
    ...
    it('should evict old entries when dedup set exceeds max size', async () => {
      // Create 10,001 unique messages to trigger eviction
      const updates: WeChatUpdate[] = Array.from({ length: 10_001 }, (_, i) => ({
        msg_id: `msg-${String(i).padStart(5, '0')}`,
        from_user_id: 'user-123',
        to_user_id: 'bot-456',
  ...
  describe('error handling', () => {
    it('should catch processor errors without stopping the listener', async () => {
      ...
      const updates2: WeChatUpdate[] = [{
        ...
        from_user_id: 'user-123',
        to_user_id: 'bot-456',
        item_list: [{ type: 1, text_item: { text: 'Second message' } }],
      ...
      // First call fails, but listener continues and processes second call too
