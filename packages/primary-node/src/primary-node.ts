...
export class PrimaryNode extends EventEmitter {
  ...
  protected async initScheduler(): Promise<void> {
    ...
    // Issue #1446: ChatAgent naturally satisfies TaskExecutionAgent (no type assertion needed)
    // Issue #2513: No ScheduleAgent/TaskAgent distinction — all agents are ChatAgent
