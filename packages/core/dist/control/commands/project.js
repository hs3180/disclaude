 ...
 */
function handleInfo(command, context) {
    ...
    const boundDir = resolution.boundWorkingDir;
 ...
 */
function handleUse(command, context) {
    const pm = context.projectManager;
    if (!pm) {
        return {
            success: false,
 ...
 */
function handleReset(command, context) {
    const pm = context.projectManager;
    if (!pm) {
        return {
            success: false,
 ...
 */
export const handleProject = (command, context) => {
