...
export const commandRegistry = [
    ...
    { type: 'project', handler: handleProject, description: '项目管理命令', usage: '/project [use|reset|info]' },
    { type: 'agent', handler: handleAgent, description: '查看或切换 Agent 预设', usage: '/agent [current|list|use <name>]' },
    { type: 'steer', handler: handleSteer, description: '运行中即时纠偏（按后端能力）', usage: '/steer <instruction>' },
];
/**
 * 获取命令处理函数
 */
