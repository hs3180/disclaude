 ...
 */
import { buildChatHistorySection, buildPersistedHistorySection, buildThreadContextSection, buildThreadSelfServiceGuidance, buildNextStepGuidance, buildOutputFormatGuidance, buildTaskRecordGuidance, buildLocationAwarenessGuidance, buildRuntimeEnvironmentGuidance, } from './guidance.js';
/**
...
export class MessageBuilder {
     ...
     */
    buildEnhancedContent(msg, chatId, capabilities) {
        const isSkillCommand = msg.text.trimStart().startsWith('/');
        const ctx = { msg, chatId, capabilities, isSkillCommand };
    ...
    buildSections(msg, chatId, capabilities) {
        const isSkillCommand = msg.text.trimStart().startsWith('/');
     ...
     */
    buildBasicAttachmentsInfo(attachments) {
