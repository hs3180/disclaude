 ...
 */
import { ClaudeSDKProvider, PiAgentProvider, CodexAgentProvider, DeepSeekHarnessProvider, } from './providers/index.js';
 ...
 * 默认 Provider 类型
 */
let defaultProviderType = 'claude';
/**
 * 缓存的 Provider 实例
 */
 ...
 */
export function registerProviderClass(type, constructor) {
 ...
 */
export function setDefaultProvider(type) {
 ...
 */
export function clearProviderCache(type) {
    if (type) {
        providerCache.delete(type);
    }
    else {
