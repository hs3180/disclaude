 ...
 */
export function getStateFilePath(projectDir) {
 ...
 */
export function createDefaultState(projectKey) {
    return {
 ...
 */
export function readProjectState(projectDir) {
 ...
 */
export function writeProjectState(projectDir, state) {
 ...
 */
export function updateSyncTimestamp(projectDir, field, projectKey) {
 ...
 * @returns Updated ProjectState, or null on error
 */
export function upsertIssue(projectDir, issueNumber, entry, projectKey) {
    const state = readProjectState(projectDir) ?? createDefaultState(projectKey);
 ...
 * @returns Updated ProjectState, or null on error
 */
export function upsertPr(projectDir, prNumber, entry, projectKey) {
    const state = readProjectState(projectDir) ?? createDefaultState(projectKey);
 ...
 */
export function isValidProjectState(data) {
    ...
    if (typeof obj.issues !== 'object' || obj.issues === null) {
        return false;
    }
    if (typeof obj.prs !== 'object' || obj.prs === null) {
        return false;
    }
    return true;
}
 ...
 */
export function isValidIssueEntry(entry) {
    ...
    if (!VALID_TRIAGE_STATUSES.has(obj.triageStatus)) {
        return false;
    }
 ...
 */
export function isValidPrEntry(entry) {
    if (typeof entry !== 'object' || entry === null) {
        return false;
    }
    const obj = entry;
    ...
    if (!VALID_REVIEW_STATUSES.has(obj.reviewStatus)) {
        return false;
    }
    return true;
}
