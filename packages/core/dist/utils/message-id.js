 ...
 */
const SYNTHETIC_MESSAGE_ID_SUFFIXES = ['-audio', '-file'];
/**
 ...
 */
export function isSyntheticMessageId(messageId) {
    return (SYNTHETIC_MESSAGE_ID_PREFIXES.some((prefix) => messageId.startsWith(prefix)) ||
