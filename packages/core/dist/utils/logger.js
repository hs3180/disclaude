    ...
    try {
        ...
        if (rotate) {
            ...
            try {
                ...
                console.warn('Log rotation symlink failed, retrying without it (filebeat still globs the numbered files):', redactDeclaredSensitive(symlinkError));
 ...
 */
function createRedactionSerializer(fields) {
