...
describe('ChatStore', () => {
  ...
  describe('registerTempChat', () => {
    ...
    it('should store triggerMode field (Issue #2193)', async () => {
    ...
    it('should persist triggerMode as undefined when not specified (Issue #2193)', async () => {
  ...
  describe('initialization', () => {
    ...
    it('should load triggerMode from disk (Issue #2193)', async () => {
      const record = {
