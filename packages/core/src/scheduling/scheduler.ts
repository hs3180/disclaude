 ...
 * @param soul - Optional per-task SOUL.md content override (Issue #1315)
 */
export type TaskExecutor = (chatId: string, prompt: string, userId?: string, model?: string, soul?: string) => Promise<void>;
...
${task.prompt}`;
  ...
  private async executeTask(task: ScheduledTask): Promise<void> {
    ...
    try {
      ...
      // Issue #1315: Pass per-task soul override for personality injection
