 ...
 * Issue #2526: Creates subdirectory structure: schedules/<dirName>/SCHEDULE.md
...
describe('ScheduleManager', () => {
  ...
  describe('file system edge cases', () => {
    ...
    it('should handle directory with non-schedule files gracefully', async () => {
      // A plain file at the root level should be ignored (not a subdirectory)
      await fs.writeFile(
...
# Bad Schedule
`;
      // Issue #2526: Write malformed content to a subdirectory's SCHEDULE.md
