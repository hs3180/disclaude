 ...
 *
 * Issue #2526: Updated to test subdirectory structure (schedules/<name>/SCHEDULE.md).
 *
...
describe('ScheduleFileScanner', () => {
  ...
  describe('parseFile', () => {
    it('should parse a valid schedule file', async () => {
      ...
      // Issue #2526: parseFile receives path to SCHEDULE.md inside a subdirectory
  ...
  describe('scanAll', () => {
    it('should scan all schedule subdirectories for SCHEDULE.md files', async () => {
      // Issue #2526: scanAll reads subdirectories with withFileTypes
  ...
  describe('writeTask', () => {
    it('should write a task to subdirectory/SCHEDULE.md with schedule- prefix stripped', async () => {
      ...
      // Issue #2526: writes to schedules/<slug>/SCHEDULE.md
    ...
    it('should call ensureDir and create subdirectory before writing', async () => {
      ...
      await scanner.writeTask(task);
      // Issue #2526: ensures schedules dir AND subdirectory are created
      expect(mockMkdir).toHaveBeenCalledWith(MOCK_DIR, { recursive: true });
  ...
  describe('deleteTask', () => {
    it('should delete a task SCHEDULE.md file and return true', async () => {
      const result = await scanner.deleteTask('schedule-daily-report');
      expect(result).toBe(true);
      // Issue #2526: deletes from subdirectory
  ...
  describe('getFilePath', () => {
    it('should return subdirectory/SCHEDULE.md path with schedule- prefix stripped', () => {
...
describe('ScheduleFileWatcher', () => {
  ...
  describe('file event handling', () => {
    ...
    it('should handle file rename event when file is added', async () => {
      ...
      // Issue #2526: recursive watch provides subdirectory-relative path
