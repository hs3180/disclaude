...
describe('ScheduleFileScanner', () => {
  ...
  describe('scanAll', () => {
    it('should scan all subdirectories for SCHEDULE.md files', async () => {
      ...
      // Verify it reads SCHEDULE.md from subdirectories
  ...
  describe('writeTask', () => {
    it('should write a task with schedule- prefix stripped for subdirectory name', async () => {
    ...
    it('should call ensureDir and create subdirectory before writing', async () => {
      ...
      await scanner.writeTask(task);
      // First call: ensure root schedules dir, second call: create subdirectory
      expect(mockMkdir).toHaveBeenCalledWith(MOCK_DIR, { recursive: true });
  ...
  describe('getFilePath', () => {
    it('should strip schedule- prefix and return subdirectory path', () => {
