 ...
 *
 * Issue #2193: Renamed from /passive to /trigger with enum values.
 */
...
describe('handleTrigger', () => {
  ...
  describe('valid arguments', () => {
    ...
    it('should set trigger mode when args is passed as array (Feishu format)', () => {
      const command = createCommand(['always']);
      const context = createContext();
      const { triggerMode } = context;
      if (!triggerMode) { throw new Error('triggerMode is required'); }
  ...
  describe('invalid arguments', () => {
    it('should reject "on" (legacy passive mode argument)', () => {
    ...
    it('should reject "off" (legacy passive mode argument)', () => {
