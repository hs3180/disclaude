...
/**
 * Project template entry in config file.
 * Allows overriding display metadata for auto-discovered templates
 * or declaring virtual templates not present on disk.
 *
