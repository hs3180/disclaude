 ...
 *   ├── Guidance sections (next-step, output format, task record, ETA rules, location awareness)
 ...
 * - ETA rules guidance (Issue #1234 Phase 2)
...
export class MessageBuilder {
  ...
  private buildRegularContent(ctx: MessageBuilderContext): string {
    ...
    const etaRulesGuidance = buildETARulesGuidance();
    ...
    sections.push(etaRulesGuidance);
