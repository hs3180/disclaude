/**
 * Agent Runtime Context - Dependency injection for platform-specific dependencies.
 *
 * This module provides the runtime context interface and global state management
 * for injecting platform-specific dependencies into the core agent layer.
 *
 * The main package implements AgentRuntimeContext and injects it via setRuntimeContext()
 * to decouple agents from platform-specific dependencies (Issue #1040).
 *
