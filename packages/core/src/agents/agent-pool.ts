 ...
 * - Short-lived agents (for task execution): Not stored here, created/disposed as needed
 */
 ...
 * Short-lived agents (for task execution) are not managed here —
 * they should be created and disposed as needed.
 */
