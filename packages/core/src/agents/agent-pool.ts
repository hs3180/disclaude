 ...
 * - Short-lived agents (scheduled tasks, one-shot tasks): Not stored here, created and disposed per execution
 */
 ...
 * Short-lived agents (for scheduled or one-shot tasks) are not
 * managed here — they are created and disposed per execution.
 */
