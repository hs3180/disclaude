...
// ============================================================================
// Runtime Context (Issue #1040, Issue #2345 Phase 4: extracted to own module)
// ============================================================================

// Re-export from runtime-context.ts for backward compatibility.
// New code should import from './runtime-context.js' directly.
export {
