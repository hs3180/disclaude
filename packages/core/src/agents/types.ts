 ...
 *
 * Simplified Architecture (ChatAgent-only, Issue #2345):
 * - ChatAgent (formerly Pilot) is the single Agent implementation in code
 ...
 * ChatAgent (formerly Pilot) implements this interface and serves as the universal agent for all scenarios:
 ...
 * @example
 * ```typescript
 * const chatAgent: ChatAgent = new Pilot(config); // Pilot is the ChatAgent implementation
...
/**
 * Configuration for ChatAgent (formerly Pilot).
 *
