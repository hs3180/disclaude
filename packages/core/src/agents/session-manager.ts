...
/**
 * @deprecated Use ChatSession instead. Renamed in Issue #2345.
 */
export type PilotSession = ChatSession;
...
export class SessionManager {
   ...
   */
  create(chatId: string, handle: QueryHandle, channel: MessageChannel): ChatSession {
