...
import { MessageBuilder } from '../message-builder/index.js';
...
import type { UserInput, ChatAgent as ChatAgentInterface } from '../types.js';
import type { AgentMessage } from '../../types/agent.js';
import type { MessageData } from '../message-builder/types.js';
...
export class ChatAgent extends BaseAgent implements ChatAgentInterface {
  ...
  constructor(config: ChatAgentConfig) {
    ...
    this.loopManager = new AgentLoopManager({
      ...
      createChannelMcpServer: config.createChannelMcpServer,
    });
