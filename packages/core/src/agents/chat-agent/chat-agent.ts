...
import { Config, BaseAgent, MessageBuilder, ConversationOrchestrator, RestartManager, type StreamingUserMessage, type ChatAgent as ChatAgentInterface, type AgentUserInput, type AgentMessage, type MessageData } from '../../index.js';
...
export class ChatAgent extends BaseAgent implements ChatAgentInterface {
  ...
  constructor(config: ChatAgentConfig) {
    ...
    this.loopManager = new AgentLoopManager({
      ...
      channelMcpFactory: config.channelMcpFactory,
    });
