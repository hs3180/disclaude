...
// ACP (Agentic Communication Protocol) infrastructure (Issue #1333)
export {
  AcpErrorCode,
  ACP_VERSION,
  AcpMethod,
  ...
  createTransport,
  // JSON-RPC functions
  createRequest as acpCreateRequest,
  createNotification as acpCreateNotification,
  createSuccessResponse as acpCreateSuccessResponse,
  createErrorResponse as acpCreateErrorResponse,
  createStandardError as acpCreateStandardError,
  validateMessage as acpValidateMessage,
  isNotification as acpIsNotification,
  isRequest as acpIsRequest,
  isResponse as acpIsResponse,
  isErrorResponse as acpIsErrorResponse,
  isSuccessResponse as acpIsSuccessResponse,
  parseMessage as acpParseMessage,
  serializeMessage as acpSerializeMessage,
} from './acp/index.js';
...
export type {
  ...
  AcpTaskMessage,
  TaskCancelParams,
  TaskStatus as AcpTaskStatus,
  TaskResult as AcpTaskResult,
  AcpUsage,
  ...
  JsonRpcMessage,
  JsonRpcBatch,
  ValidationResult as AcpValidationResult,
  ParseResult as AcpParseResult,
  // Transport types
  MessageHandler as AcpMessageHandler,
  ErrorHandler as AcpErrorHandler,
  TransportState as AcpTransportState,
  AcpTransport,
} from './acp/index.js';
