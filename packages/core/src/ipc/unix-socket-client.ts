 ...
 *
 * Provides connection lifecycle management and low-level request/response
 * handling over Unix domain sockets.
 *
 * Issue #4129: Protocol convenience methods (sendMessage, sendCard, etc.)
 * have been extracted to ipc-client-facade.ts. Utility functions
 * (getIpcSocketPath, getIpcClient, etc.) have been extracted to ipc-utils.ts.
 *
