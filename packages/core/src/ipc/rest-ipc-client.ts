 ...
 *
 * Issue #4801 (P7): the single source of truth for the default base URL, so the
 * PrimaryNode server, the channel-cli client and push-cli can't silently drift
 * on the port (changing it here updates every consumer).
 */
