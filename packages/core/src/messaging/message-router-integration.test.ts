...
describe('Integration: UserMessage end-to-end (Feishu → MessageRouter → Agent)', () => {
  ...
  it('should route multiple UserMessages to different chats', async () => {
    ...
    expect(handler.handleUserMessage).toHaveBeenNthCalledWith(1, 'oc_chatA', 'Message A', 'fm-1', 'ou_sender1', undefined, undefined, undefined);
    expect(handler.handleUserMessage).toHaveBeenNthCalledWith(2, 'oc_chatB', 'Message B', 'fm-2', 'ou_sender1', undefined, undefined, undefined);
    expect(handler.handleUserMessage).toHaveBeenNthCalledWith(3, 'oc_chatA', 'Follow-up A', 'fm-3', 'ou_sender1', undefined, undefined, undefined);
  });
});
