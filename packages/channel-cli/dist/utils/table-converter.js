 ...
 *
 * @module channel-cli/utils/table-converter
 */
/**
 ...
 */
export function parseGfmTable(content) {
 ...
 * @see https://open.feishu.cn/document/common-capabilities/message-card/message-cards-content/using-column-set
 */
export function buildTableColumnSets(headers, rows) {
 ...
 */
export function buildColumnSet(headers, rows) {
 ...
 */
export function transformCardTables(card) {
    const { elements } = card;
