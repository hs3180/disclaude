 ...
 */
import { createLogger, sendCard } from "../../../core/dist/index.js";
 ...
 */
async function sendCardViaChannelApi(chatId, card, threadId, description) {
    ...
    return await sendCard(apiClient, chatId, card, threadId, description);
}
/**
