...
it.skipIf(process.env.DISCLAUDE_E2E_CODEX_INPUT !== '1')('answers a real Codex tool question through its native card and completes the original turn', async () => {
