 ...
 *
 * Issue #697: Refactored to extract types and message builder for better modularity.
 *
 * Key Features:
 ...
 * - MessageBuilder: Enhanced content building with context
...
import { buildEnhancedContent } from './message-builder.js';
...
export class Pilot extends BaseAgent implements ChatAgent {
  ...
  async executeOnce(
    ...
    // Build enhanced content with context using extracted function
    const enhancedContent = buildEnhancedContent(
      {
        text,
