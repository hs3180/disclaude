...
/**
 * Allowed tools for Evaluator agent.
 * These tools are used to read files and write evaluation results.
 */
...
export class Evaluator extends BaseAgent {
   ...
   * No skill loading needed - tools are defined directly in code.
   */
