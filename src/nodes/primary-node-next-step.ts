/**
 * Primary Node Next-Step Recommendations
 *
 * Extracted from primary-node.ts (Issue #695)
 * Handles triggering next-step recommendations after task completion.
 */
...
const logger = createLogger('PrimaryNodeNextStep');

/**
 * Service for generating next-step recommendations after task completion.
 *
 ...
 */
export class NextStepRecommender {
  /**
   ...
   */
  async trigger(chatId: string, threadId?: string): Promise<void> {
