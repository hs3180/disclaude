 ...
 * Mention Detector.
 *
 * Handles bot mention detection for Feishu messages.
 * Correctly identifies when the bot is @mentioned in group chats.
 *
...
/**
 * MentionDetector - Detects bot mentions in Feishu messages.
 *
