/**
 * Mention Detector for Feishu Channel.
 *
 * Handles bot mention detection in group chats.
 *
...
/**
 * MentionDetector - Detects when the bot is mentioned in messages.
 *
 * This class handles the complexity of bot mention detection in Feishu,
 * where mentions can reference the bot by either open_id or app_id.
 */
export class MentionDetector {
   ...
   * This must be called during initialization to enable accurate mention detection.
   *
