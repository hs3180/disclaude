...
const ROUTES = {
  browser: { file: resolve(ROOT, 'packages/service/dist/browser-control/cli.mjs') },
  start: {
    file: resolve(ROOT, 'packages/service/dist/cli.js'),
    keepCommand: true,
  },
  channel: {
    file: resolve(ROOT, 'packages/channel-cli/dist/cli.js'),
