...
Files stored in `workspace/schedules/` as Markdown files in subdirectory layout.
...
2. Generate subdirectory path: `workspace/schedules/{name}-{uuid}/SCHEDULE.md`

3. Create directory and file with `Write` tool (parent directories are auto-created)
