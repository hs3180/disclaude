...
To enable automatic topic initiation, copy the schedule template from `skills/bbs-topic-initiator/schedule.md` to `schedules/bbs-topic-initiation/SCHEDULE.md` and replace the `{controlChannelChatId}` placeholder with the actual chatId.
