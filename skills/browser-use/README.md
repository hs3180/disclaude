...
and a PATH selecting the IPC adapter. The coordinator queues callers and owns
connection recovery. It reuses upstream browser-use helpers and harness execution.
