...
allowed-tools: [Bash, Read, Write, Glob, Grep, send_text, send_interactive, send_card]
---
...
5. **Single responsibility**: Only initiate discussions; lifecycle managed by other skills
