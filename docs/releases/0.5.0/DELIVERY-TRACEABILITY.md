...
| [#4724](https://github.com/hs3180/disclaude/issues/4724) | S01-A2/A3 | `packages/service/src/chat-session-pool.ts` | 真实切换、失败保持原预设、chat 隔离 |
...
| [#4808](https://github.com/hs3180/disclaude/issues/4808) | S03-A1 | `packages/service/src/agents/chat-agent.ts` | 按 messageId 结算、乱序/重复/过期回合 |
...
| [#4208](https://github.com/hs3180/disclaude/issues/4208) | S04-A1/A2 | `packages/service/src/channels/feishu-channel.ts` | 真实 CardKit 更新收尾与失败降级回归 |
...
| [#4747](https://github.com/hs3180/disclaude/issues/4747) | S04-A3 | `packages/service/src/agents/chat-agent.ts` | 工具后无正文、失败与取消有明确终态 |
| [#4770](https://github.com/hs3180/disclaude/issues/4770) | S04-A3 | `packages/service/src/agents/chat-agent.ts` | 未知错误可诊断；显式 stop 不误作熔断 |
| [#4746](https://github.com/hs3180/disclaude/issues/4746) | S04-A4 | `packages/service/src/channels/feishu/message-filters.ts` | 原子去重及回合/投递可观测性 |
...
| [#4824](https://github.com/hs3180/disclaude/issues/4824) | S05-A2/A3 | `packages/service/src/chat-session-pool.ts` | 双实例随机端口、受管环境传播、重启新地址 |
...
| [#4795](https://github.com/hs3180/disclaude/issues/4795) | S06-A4 | `packages/service/src/agents/history-manager.ts` | 首轮快照、预算与并发读取 |
