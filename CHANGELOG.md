...
- **Skill Agent System** - Background skill agent execution with Feishu control commands (#455)
  - SkillAgentManager for process lifecycle management
  - `/skill` commands: run, list, status, stop, stop-all
  - Playwright Skill Agent as sample background skill
